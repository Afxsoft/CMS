    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse">
            ...
            <ul class="nav navbar-nav navbar-right hidden-xs">
                <!-- Sign in & Sign up -->
                <li id="sign-up" class="show"><a href="/page/calendrier/"><i class="fa fa-calendar"></i> Calendrier</a>
                </li>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-6 col-sm-12">
                                <h1 class="animated slideInDown">Mini-bus pour le transport du personnel de votre
                                    société</h1>
                            </div>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-6 col-sm-12">
                                ...
                                <div class="list">
                                    <ul>
                                        <li class="animated slideInLeft first delay"><span><i class="fa fa-smile-o"></i> <span>Toujours autant de confort.</span></span>
                                        </li>
                                        <li class="animated slideInLeft second delay"><span><i
                                                        class="fa fa-life-ring"></i> <span>La sécurité, une priorité.</span></span>
                                        </li>
                                        <li class="animated slideInLeft third delay"><span><i
                                                        class="fa  fa-recycle"></i> <span>Bus écolo.</span></span></li>
                                    </ul>
                                </div>
                            </div>
                            <div class="col-md-6 hidden-sm hidden-xs">
