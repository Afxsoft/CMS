...
<div class="row">
  ...
  <div class="col-md-8">
    ...
    <div class="block-header">
      <h2>
        <span class="title">Le mot président</span><span class="decoration"></span><span class="decoration"></span><span class="decoration"></span>
      </h2>
    </div>
    <img src="/Public/app/img/about.jpg" class="img-about img-responsive" alt="About">
    <p>
  ...
  <div class="col-md-4">
    <div class="block-header">
      <h2>
        <span class="title">Evenement</span><span class="decoration"></span><span class="decoration"></span><span class="decoration"></span>
      </h2>
    </div>
    ...
    <div class="block-header">
      <h2>
        <span class="title">Météo</span><span class="decoration"></span><span class="decoration"></span><span class="decoration"></span>
      </h2>
    </div>
    <a href="http://www.accuweather.com/fr/fr/paris/623/weather-forecast/623" class="aw-widget-legal">
    </a><div id="awcc1416771270638" class="aw-widget-current"  data-locationkey="623" data-unit="c" data-language="fr" data-useip="false" data-uid="awcc1416771270638"></div><script type="text/javascript" src="http://oap.accuweather.com/launch.js"></script>
  </div>
</div>
<!-- Recent Works
  =================== -->
<div class="row">
  <div class="col-md-12 block-header">
    <h2>
      <span class="title">Actualité</span><span class="decoration"></span><span class="decoration"></span><span class="decoration"></span>
    </h2>
  </div>
</div>
<div class="row">
  <div class="col-md-3 col-sm-6">
    <div class="thumbnail">
      <img src="/Public/app/img/works1.jpg" class="img-responsive" alt="...">
      <div class="visit"><a href="#"><i class="fa fa-question-circle"></i> Lire plus...</a></div>
      <div class="caption">
        <h4>Actu #1</h4>
  ...
  <div class="col-md-3 col-sm-6">
    <div class="thumbnail">
      <img src="/Public/app/img/works2.jpg" class="img-responsive" alt="...">
      <div class="visit"><a href="#"><i class="fa fa-question-circle"></i> Lire plus...</a></div>
      <div class="caption">
        <h4>Actu #2</h4>
        <p>Cras justo odio, dapibus ac facilisis in, egestas eget quam.</p>
  ...
  <div class="col-md-3 col-sm-6">
    <div class="thumbnail">
      <img src="/Public/app/img/works3.jpg" class="img-responsive" alt="...">
      <div class="visit"><a href="#"><i class="fa fa-question-circle"></i> Lire plus...</a></div>
      <div class="caption">
        <h4>Actu #3</h4>
        <p>Cras justo odio, dapibus ac facilisis in, egestas eget quam.</p>
  ...
  <div class="col-md-3 col-sm-6">
    <div class="thumbnail">
      <img src="/Public/app/img/works4.jpg" class="img-responsive" alt="...">
      <div class="visit"><a href="#"><i class="fa fa-question-circle"></i> Lire plus...</a></div>
      <div class="caption">
        <h4>Actu #4</h4>
        <p>Cras justo odio, dapibus ac facilisis in, egestas eget quam.</p>
